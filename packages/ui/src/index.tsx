...
export const THEME_PRESETS: VisualTheme[] = [
  ...
  },
  {
    ...
    wallpaperBlur: 0,
    wallpaperDim: 0.5,
    effects: { ...DEFAULT_THEME_EFFECTS, glass: true, noise: true, vignette: true, glow: true, particles: true, parallax: false, glassBlur: 22, glassOpacity: 0.58 },
  ...
  },
  {
    ...
    wallpaperBlur: 2,
    wallpaperDim: 0.35,
    effects: { ...DEFAULT_THEME_EFFECTS, glass: false, noise: true, vignette: true, glow: false, particles: false, parallax: false, glassOpacity: 0.45 },
    motionIntensity: "medium",
  ...
  },
  {
    ...
    wallpaperBlur: 4,
    wallpaperDim: 0.4,
    effects: { ...DEFAULT_THEME_EFFECTS, glass: true, noise: false, vignette: false, glow: true, particles: true, parallax: true, glassBlur: 28, glassSaturation: 1.6 },
    motionIntensity: "high",
    buttonStyle: "tonal",
    cardStyle: "glass",
  },
  ...
  },
  {
    ...
    wallpaperBlur: 0,
    wallpaperDim: 0.6,
    effects: { ...DEFAULT_THEME_EFFECTS, glass: false, noise: true, vignette: false, glow: true, particles: false, parallax: false, glassBlur: 14 },
    motionIntensity: "medium",
    buttonStyle: "tonal",
    cardStyle: "solid",
  },
